...
Играчот(со ликот на Цацко) може да се движи лево и десно со помош на стрелките од тастатура или копчињата <kbd>А</kbd> и <kbd>D</kbd> (како што е наведено и на почетниот прозорец). Ова е овозможено на следниот начин:
